...
- Phase: Prompts 00–04 committed (`2b2dfbd`, `c0614a2`, `081c8d5`, `0e6f734`, `a412d6f`). Prompt 05 homepage complete in working tree: hero, profile+career grid, project disclosure, experience, capabilities, leadership/recognition, contact composer, footer. 17 tests green; format/lint/typecheck/build pass. `docs/VISUAL_QA.md` written (browser viewport rows still Pending). Case-study links hidden until Prompt 06. Next: commit 05, then Prompt 06 routes.
