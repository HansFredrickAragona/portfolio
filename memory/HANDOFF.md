...
Latest skills presentation: initially-collapsed native category disclosures, smooth 300ms size/fade where supported, reduced-motion instant fallback, concise item/category labels. All existing 31 tests and build pass; click/keyboard/browser checks completed. Preview remains port 3112 after restart. Evidence remains in model fields even though descriptions are not displayed.
